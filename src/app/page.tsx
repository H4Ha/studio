...
export default function Home() {
  const [state, formAction, isPending] = useActionState(analyzeUrlAction, initialState);
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        <section className="max-w-3xl mx-auto">
          <UrlForm formAction={formAction} status={isPending ? 'loading' : state.status} />
...
const LoadingIndicator = () => (
  <div className="text-center animate-in fade-in-0 duration-300">
    <div className="flex justify-center items-center gap-3 text-muted-foreground">
      ...
      <span className="font-semibold text-lg font-headline">Analyzing Live URL...</span>
    </div>
    <p className="mt-2 text-sm">Fetching and scrutinizing the digital page. This may take a moment.</p>
  </div>
);
